...
const firebaseConfig = {
  apiKey: "AIzaSyBnCZHeEvoduVLzQbbzFgkH4OqLOD9CgRI",
...
async function initializeFirestore() {
  try {
    ...
    await setDoc(doc(db, 'adminState', 'config'), MOCK_ADMIN_STATE);
    console.log('✅ Admin state initialized');

    // Create a sample admin user document (optional)
    // This would normally be handled by Firebase Auth
    console.log('✅ Firestore initialization complete!');
    console.log('You can now login with admin@codeastra.com');
